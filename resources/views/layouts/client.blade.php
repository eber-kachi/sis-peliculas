...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('client/css/barfiller.css')}}" type="text/css">
...
<section class="hero-section">
    <div class="hs-slider owl-carousel">
        <div class="hs-item set-bg" data-setbg="{{asset('client/img/hero/hero-1.jpg')}}">
            <div class="container">
                <div class="row">
        ...
        <div class="hs-item set-bg" data-setbg="{{asset('client/img/hero/hero-2.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        <div class="hi-text">
